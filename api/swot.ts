    ...
    messages: [
      {
        ...
        제시된 사업 아이템과 창업 단계를 토대로 SWOT 분석을 진행해줘.
        그리고 결과 내용을 바탕으로 분석 결과 요약을 작성해줘. 서비스가 성장하기 위해 필요한 전략와 진행 방향에 대해 간결히 제안해줘.  답변해줘. 그리고 '5. 분석 결과 요약' 의 글자수는 190자 이상 250자 이하로 작성하고 문장은 '-해요' 문체로 작성해줘.'
